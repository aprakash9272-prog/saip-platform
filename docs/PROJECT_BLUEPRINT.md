...
Simulation and the AI Assistant (Sections 9–13) are intentionally not yet implemented — Sprints 3–10 exist to build the knowledge base, customer workspace, and coverage/gap/recommendation/overlap calculation those remaining engines will consume or complement.
