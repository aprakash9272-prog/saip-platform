...
Overlap, Recommendation, Simulation, and AI Assistant engines (Sections 9–13) are intentionally not yet implemented — Sprints 3–8 exist to build the knowledge base, customer workspace, and coverage/gap calculation those engines will consume.
